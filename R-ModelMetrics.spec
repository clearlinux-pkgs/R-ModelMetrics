...
Version  : 1.2.0
Release  : 12
URL      : https://cran.r-project.org/src/contrib/ModelMetrics_1.2.0.tar.gz
Source0  : https://cran.r-project.org/src/contrib/ModelMetrics_1.2.0.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1533953481
