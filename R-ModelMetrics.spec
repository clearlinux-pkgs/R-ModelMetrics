...
%prep
%setup -q -n ModelMetrics
pushd ..
cp -a ModelMetrics buildavx2
popd
pushd ..
cp -a ModelMetrics buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1737151389
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/R/library/ModelMetrics/libs/ModelMetrics.so
/V4/usr/lib64/R/library/ModelMetrics/libs/ModelMetrics.so
